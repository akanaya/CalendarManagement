...
import { GardeComponent } from 'app/entities/garde/garde.component';
import { GardeService } from 'app/entities/garde/garde.service';
import { Garde } from 'app/shared/model/garde.model';

describe('Component Tests', () => {
    describe('Garde Management Component', () => {
        let comp: GardeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GardeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gardes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
